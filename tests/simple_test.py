...
name = iec61850.MmsVariableAccessSpecification_create ("TestDomain", "Transfer_Set_Name")
tst = iec61850.MmsVariableAccessSpecification_create ("TestDomain", "Transfer_Set_Time_Stamp")
dsc = iec61850.MmsVariableAccessSpecification_create ("TestDomain", "DSConditions_Detected")
